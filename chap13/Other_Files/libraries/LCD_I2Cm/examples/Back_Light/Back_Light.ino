/*
  LiquidCrystal Library - Back Light
...
void loop() {
  // Note depending on how the backlight is wired up through a transistor
  // will determin if a true of false turns it on or off.
